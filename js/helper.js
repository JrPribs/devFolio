...
var HTMLworkTop = '<div id="work-top" class="section clear-fix"></div>';
...
var HTMLonlineUrl = '<a class="codeschool-title" href="%data%">';
var HTMLonlineTitle = '%data%</a>';
var HTMLcodeSchool = '<h3 class="online-course">CodeSchool.com</h3><div id="codeschool-courses"></div>';
var HTMLcodeSchoolCourse = '<div class="codeschool-course"></div>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<div class="codeschool-title"><a href="#">%data%</a>';
